...
@interface ActorViewController ()<placeSelectDelegate,TTTSelectViewDelegate,TimeSelectDelegate,UIScrollViewDelegate,UITextViewDelegate,PicSelectDelegate,UIAlertViewDelegate,UITextFieldDelegate>
{
    UIScrollView *mainSC;
    UITextField *topic;
    UILabel *workPlace;
...
- (void)viewDidLoad {
    ...
    UILabel *titleLabel = [MyControll createLabelWithFrame:CGRectMake(0, 0, 50, 35) title:@"招募艺人" font:20];
...
-(void)makeUI
{
    ...
    UIView *firstView = [MyControll createToolView2WithFrame:CGRectMake(0, 15, WIDTH, 240) withColor:[UIColor whiteColor] withNameArray:@[@"主       题",@"工作地区",@"详细地址",@"艺人类别",@"薪资待遇",@"截止时间"]];
    ...
    workPlace = [MyControll createLabelWithFrame:CGRectMake(WIDTH/5+40, 45, WIDTH/5*4-50, 30) title:@"工作地区" font:14];
    ...
    actorType = [MyControll createLabelWithFrame:CGRectMake(WIDTH/5+40, 125, WIDTH/5*4-50, 30) title:@"艺人类别" font:14];
    actorType.textColor =[UIColor colorWithRed:0.82f green:0.82f blue:0.84f alpha:1.00f];
    [firstView addSubview:actorType];
    
    lmoney = [MyControll createTextFieldWithFrame:CGRectMake(WIDTH/5+40, 165, 60, 30) text:nil placehold:@"最低薪资" font:14];
    ...
    hmoney = [MyControll createTextFieldWithFrame:CGRectMake(WIDTH/5+120, 165, 60, 30) text:nil placehold:@"最高薪资" font:14];
    hmoney.layer.borderWidth = 0.5;
    hmoney.delegate = self;
    ...
    UILabel *yuan = [MyControll createLabelWithFrame:CGRectMake(WIDTH/5+185, 165, 30, 30) title:@"元" font:14];
    ...
    UILabel *tishi = [MyControll createLabelWithFrame:CGRectMake(20, 440, 100, 20) title:@"招募详情" font:14];
...
-(void)loadData
{
    ...
    NSString *urlstr = [NSString stringWithFormat:@"%@careatenote1",SERVER_URL];
