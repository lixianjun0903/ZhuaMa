...
@interface OfflineViewController ()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate>
{
    UIImageView *topNav;
    UIView *leftView;
    UILabel *huodongName;
...
@property(nonatomic,strong)ImageDownManager *fourDownManager;@end
...
- (void)viewDidLoad
{
    ...
    UILabel *titleLabel = [MyControll createLabelWithFrame:CGRectMake(0, 0, 50, 35) title:@"线下邀约" font:20];
...
-(void)loadData
{
    ...
    NSString *token = [user objectForKey:@"token"];
    [self StartLoading];
    NSString *urlstr = [NSString stringWithFormat:@"%@yaoyueinfo?uid=%@&token=%@",SERVER_URL,uid,token];
