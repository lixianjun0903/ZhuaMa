...
#import "ProjectTypeSelectView.h"

@implementation ProjectTypeSelectView
...
-(void)loadData
{
    ...
    NSArray *key = @[@"电影",@"电视剧",@"综艺节目",@"微电影",@"网络剧",@"游戏",@"动漫产品",@"APP",@"其他"];
    NSArray *value = @[@"1",@"2",@"3",@"4",@"5",@"6",@"7",@"8",@"9"];
...
{
    [_delegate selectProType:self.dataArray[indexPath.row][@"key"] ID:self.dataArray[indexPath.row][@"value"]];
    [self removeFromSuperview];
}
@end
