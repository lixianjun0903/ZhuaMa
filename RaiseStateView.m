...
-(void)loadData
{
    ...
    NSArray *key = @[@"天使投资",@"PreA阶段",@"A轮",@"B轮",@"C轮",@"D轮"];
    NSArray *value = @[@"1",@"2",@"3",@"4",@"5",@"6"];
...
{
    [_delegate selectRaiseState:self.dataArray[indexPath.row][@"key"] ID:self.dataArray[indexPath.row][@"value"]];
    [self removeFromSuperview];
}
@end
