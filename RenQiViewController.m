...
@interface RenQiViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation RenQiViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    self.dataArray = [NSMutableArray arrayWithCapacity:0];
    UILabel *titleLabel = [MyControll createLabelWithFrame:CGRectMake(0, 0, 50, 35) title:@"人气榜" font:20];
...
-(void)loadData
{
    ...
    NSString *urlstr = [NSString stringWithFormat:@"%@sourcelist?uid=%@&token=%@",SERVER_URL,uid,token];
