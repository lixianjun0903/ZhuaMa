...
@interface SkillViewController ()<placeSelectDelegate,TTTSelectViewDelegate,TimeSelectDelegate,UIScrollViewDelegate,UITextViewDelegate,PicSelectDelegate,UIAlertViewDelegate,UITextFieldDelegate>
{
    UIScrollView *mainSC;
    UITextField *topic;
    UILabel *workPlace;
...
- (void)viewDidLoad {
    ...
    UILabel *titleLabel = [MyControll createLabelWithFrame:CGRectMake(0, 0, 50, 35) title:@"技能供应" font:20];
...
-(void)makeUI
{
    ...
    UIView *firstView = [MyControll createToolView2WithFrame:CGRectMake(0, 15, WIDTH, 240) withColor:[UIColor whiteColor] withNameArray:@[@"主       题",@"所在地区",@"详细地址",@"技能类别",@"价       格",@"截止时间"]];
    ...
    actorType = [MyControll createLabelWithFrame:CGRectMake(WIDTH/5+40, 125, WIDTH/5*4-50, 30) title:@"技能类别" font:14];
    ...
    UILabel *tishi = [MyControll createLabelWithFrame:CGRectMake(20, 440, 100, 20) title:@"技能详情" font:14];
...
//    [dic setObject:hmoney.text forKey:@"hmoney"];
    ...
    NSString *urlstr = [NSString stringWithFormat:@"%@careatenote3",SERVER_URL];
