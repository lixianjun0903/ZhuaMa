...
@interface TongGaoDetailViewController ()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate>
{
    UIImageView *topNav;
    UIView *leftView;
    UILabel *huodongName;
...
@implementation TongGaoDetailViewController
