...
-(void)loadData:(NSString *)str
{
    ...
    [self StartLoading];
    NSString *urlstr = [NSString stringWithFormat:@"%@citylist?pid=%@",SERVER_URL,str];
...
{
    [ _delegate selectCityDetail:self.dataArray[indexPath.row][@"value"] ID:self.dataArray[indexPath.row][@"id"]];
