//
//  PressBaoLiaoNewViewController.m
//  ZhuaMa
//
...
@interface PressBaoLiaoNewViewController ()<UITextViewDelegate,UIScrollViewDelegate,emoticonDelegate,PicSelectDelegate>
{
...
@implementation PressBaoLiaoNewViewController
...
//    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(keyboardWillHide:) name:UIKeyboardWillHideNotification object:nil];
    ...
    faceBtn = [MyControll createButtonWithFrame:CGRectMake(20, 0, 30, 50) bgImageName:nil imageName:@"77" title:nil selector:@selector(faceClick:) target:self];
    [faceBtn setImage:[UIImage imageNamed:@"jianpan"] forState:UIControlStateSelected];
    faceBtn.selected = YES;
    [imageView addSubview:faceBtn];
    
    UIButton * photoBtn = [MyControll createButtonWithFrame:CGRectMake(85, 0, 30, 50) bgImageName:nil imageName:@"78" title:nil selector:@selector(photoClick) target:self];
    [imageView addSubview:photoBtn];
