...
@interface PressTrendViewController ()<UITextViewDelegate,UINavigationControllerDelegate,UIAlertViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate>
{
    UITextView *textView;
    UIView *picView;
...
@implementation PressTrendViewController
...
-(void)makeUI
{
    ...
    UILabel *tishiLabel = [MyControll createLabelWithFrame:CGRectMake(5, 10, WIDTH-10, 20) title:@"说点圈内相关动态吧！" font:15];
    tishiLabel.tag = 1;
...
-(void)createBottomView
{
    ...
    UIButton *faceBtn = [MyControll createButtonWithFrame:CGRectMake((WIDTH/2 - 30)/2, 0, 30, 50) bgImageName:nil imageName:@"77" title:nil selector:@selector(faceClick) target:self];
    [imageView addSubview:faceBtn];
    
    photoBtn = [MyControll createButtonWithFrame:CGRectMake(WIDTH/2 + (WIDTH/2 - 30)/2, 0, 30, 50) bgImageName:nil imageName:@"78" title:nil selector:@selector(photoClick) target:self];
