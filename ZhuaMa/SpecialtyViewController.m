...
- (void)viewDidLoad {
    ...
    UILabel *titleLabel = [MyControll createLabelWithFrame:CGRectMake(0, 0, 50, 35) title:@"选择技能特长" font:20];
...
-(void)loadData
{
    ...
    [self StartLoading];
    NSString *urlstr = [NSString stringWithFormat:@"%@choiselist?type=5",SERVER_URL];
...
-(void)btnClick:(UIButton *)sender
{
    ...
    [delegate changeSpecialty:self.selectArray];
